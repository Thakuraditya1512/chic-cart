        ...
        <div className="terms-animate space-y-8">
          <section>
            ...
            <p className="text-sm text-muted-foreground font-sans leading-relaxed">
              By accessing or using FlexTheKicks, you agree to be bound by these Terms of Service. 
          ...
          <section>
            ...
            <p className="text-sm text-muted-foreground font-sans leading-relaxed">
              To make purchases, you must create an account. You are responsible for maintaining 
          ...
          <section>
            ...
            <p className="text-sm text-muted-foreground font-sans leading-relaxed">
              We strive to display accurate product information, including images, descriptions, 
              and pricing. However, we do not guarantee that all information is accurate, complete, 
              or current. Colors may appear differently on various devices.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-sm text-muted-foreground font-sans leading-relaxed">
              ...
              Payment must be made at the time of ordering through our approved payment methods.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-sm text-muted-foreground font-sans leading-relaxed">
              ...
              caused by shipping carriers or circumstances beyond our control. Risk of loss and 
          ...
          <section>
            ...
            <p className="text-sm text-muted-foreground font-sans leading-relaxed">
              Returns are accepted within 7 days of delivery for unworn products in original 
              condition. Refunds are processed within 5-7 business days after we receive the 
              returned item. Sale items may have different return policies.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-sm text-muted-foreground font-sans leading-relaxed">
              ...
              property of FlexTheKicks or its content suppliers and is protected by copyright 
