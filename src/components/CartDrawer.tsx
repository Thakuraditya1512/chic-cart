...
const CartDrawer = () => {
  ...
  const WHATSAPP_NUMBER = "+919398415366"; // REPLACE WITH ACTUAL PHONE NUMBER WITH COUNTRY CODE 
              ...
              <div className="p-4 border-t border-border space-y-4">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <button
                    ...
                    className="w-full py-3.5 bg-[#25D366] text-white flex items-center justify-center gap-2 font-medium text-sm uppercase tracking-wider hover:opacity-90 transition-opacity rounded-sm"
                  >
