        ...
        <div className="max-w-2xl mx-auto text-center">
          ...
          >
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className="btn-glow px-6 sm:px-8 py-3 sm:py-4 bg-foreground text-background text-xs font-sans font-semibold uppercase tracking-[0.15em] rounded-full flex items-center justify-center gap-2 hover:opacity-90 transition-opacity whitespace-nowrap"
            >
              {submitted ? (
                <>
                  <Check size={14} />
          ...
          {submitted && (
            <motion.p
              ...
              className="mt-4 sm:mt-6 text-xs sm:text-sm text-foreground/60 font-sans"
            >
